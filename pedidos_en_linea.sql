...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-09-2023 a las 05:15:11
...
--
-- Base de datos: `pedidos_en_linea`
--
...
--
ALTER TABLE `detalles`
  ADD CONSTRAINT `detalles_ibfk_1` FOREIGN KEY (`idPedido`) REFERENCES `pedidos` (`idPedido`),
